...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: "/getSubjects", // JSON file to add data subject
      columns: [
          ...
          render: function (data, type, full, meta) {
            let parent = `
              <div class="d-flex align-items-center">
                <a href="/subject/edit/${full.id}" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a>
                <a onclick="return confirm('Are you sure?')" href="/subject/delete/${full.id}" class="text-body "><i class="ti ti-trash ti-sm mx-2"></i></a>
