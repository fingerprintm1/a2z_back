      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            return `<a href="/course/${$course.id}" class="text-truncate d-flex align-items-center">${$course.name}</a>`;
          },
        },
        {
          targets: 4,
          ...
          render: function (data, type, full, meta) {
            let parent = `
              <div class="d-flex align-items-center">
                ...
                <a onclick="return confirm('هل انت متأكد')" href="/comment/delete/${full.id}" class="text-bod   y"><i class="ti ti-trash ti-sm mx-2"></i></a>
