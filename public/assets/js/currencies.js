...
$(function () {
  ...
  if (dt_user_table.length) {
    ...
    var dt_user = dt_user_table.DataTable({
      processing: true,
      ajax: "/getCurrenciesApi", // JSON file to add data
      columns: [
      ...
      columnDefs: [
        ...
        },
        {
          ...
          targets: 3,
          render: function (data, type, full, meta) {
            var currency_symbol = full[`currency_symbol`];

            return "<span class='text-truncate d-flex align-items-center'>" + currency_symbol + "</span>";
          },
        },
        {
          // product price
          targets: 4,
          render: function (data, type, full, meta) {
            var currency_rate = full["currency_rate"];
            return "<span class='text-truncate d-flex align-items-center'>" + currency_rate + "</span>";
          },
        },
        {
          ...
          render: function (data, type, full, meta) {
            let parent = `
              <div class="d-flex align-items-center">
                <a href="/currency/edit/${full.id}" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a>
                <a onclick="return confirm('Are you sure?')" href="/currency/delete/${full.id}" class="text-body "><i class="ti ti-trash ti-sm mx-2"></i></a>
