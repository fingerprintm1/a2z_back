        ...
        return (
            (function() {
                ...
                var h = [
                    ...
                    p = ['light', 'dark'],
                    m = document.documentElement.classList,
                    y = document.getElementsByTagName('HTML')[0].getAttribute('data-theme') || 0,
                    f = m.contains('dark-style') ? 'dark' : 'light',
                    g = 'rtl' === document.documentElement.getAttribute('dir'),
                    v = !!m.contains('layout-menu-collapsed'),
                    b = !!m.contains('layout-menu-flipped'),
                    _ = !!m.contains('layout-navbar-fixed'),
                    x = !!m.contains('layout-footer-fixed'),
                    w = m.contains('layout-menu-offcanvas') ?
                    'static-offcanvas' :
                    m.contains('layout-menu-fixed') ?
                    'fixed' :
                    m.contains('layout-menu-fixed-offcanvas') ?
                    'fixed-offcanvas' :
                    'static',
                    S = (function() {
                        function t(e) {
                            var s = e.cssPath,
                                ...
                                m = e.defaultNavbarFixed,
                                S = e.defaultFooterFixed,
                                z = e.styles,
                                F = e.defaultStyle,
                                k = e.availableThemes,
                                C = e.defaultTheme,
                            ...
                            if (
                                ...
                                if (
                                    ((this.settings = {}),
                                        ...
                                        (this.settings.controls = n || h),
                                        (this.settings.defaultTextDir = 'rtl' === l || g),
                                        (this.settings.defaultLayoutType = r || w),
                                        (this.settings.defaultMenuCollapsed = void 0 !== c ? c : v),
                                        (this.settings.defaultMenuFlipped = void 0 !== u ? u : b),
                                        (this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : undefined),
                                        (this.settings.defaultNavbarFixed = void 0 !== m ? m : _),
                                        (this.settings.defaultFooterFixed = void 0 !== S ? S : x),
                                        (this.settings.availableThemes = k || t.THEMES),
                                        (this.settings.defaultTheme = this._getDefaultTheme(void 0 !== C ? C : y)),
                                        (this.settings.styles = z || p),
                                        (this.settings.defaultStyle = F || f),
                                    ...
                                    1 !== E &&
                                        (this.settings.controls = this.settings.controls
                                            .slice(0, E)
                                            .concat(this.settings.controls.slice(E + 1)));
                                }
                            ...
                            (s = [{
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        this._hasControls('style') &&
                                            (this._setSetting('Style', -1 === ['dark'].indexOf(t) ? 'light' : t), window.location.reload());
                                    }
                                },
                                {
                                    key: 'setTheme',
                                            ...
                                            if (i) {
                                                ...
                                                var o = this.pathResolver(
                                                    ...
                                                    this.settings.cssFilenamePattern.replace(
                                                        '%name%',
                                                        t + ('light' !== this.settings.style ? '-'.concat(this.settings.style) : '')
                                                    )
                                                );
                                                this._loadStylesheets(
                                                        c({}, o, document.querySelector('.template-customizer-theme-css')),
                                                        s || function() {}
                                                    ),
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        ...
                                        if (
                                            ...
                                            ('static' === t || 'static-offcanvas' === t || 'fixed' === t || 'fixed-offcanvas' === t)
                                        ) {
                                    ...
                                    value: function(e) {
                                        ...
                                        if (e !== this.settings.lang || i) {
                                            ...
                                            for (
                                                ...
                                                n[l].querySelector('.template-customizer-theme-name').textContent =
                                                    a[c] || this._getThemeByName(c).title;
                                            }
                                    ...
                                    value: function() {
                                        if (!this._ssr) {
                                            var t = !!document.querySelector('.layout-navbar'),
                                                ...
                                                i =
                                                (document.querySelector('.layout-wrapper.layout-navbar-full'), !!document.querySelector('.content-footer'));
                                            this._controls.layoutMenuFlipped &&
                                                ...
                                                (i ?
                                                    ...
                                                    (this._controls.layoutFooterFixed.setAttribute('disabled', 'disabled'),
                                                        this._controls.layoutFooterFixedW.classList.add('disabled'))), !e &&
                                                'fixed' == this.settings.layoutType &&
                                                this._hasControls('layoutNavbarFixed') &&
                                                (this._controls.layoutNavbarFixed.setAttribute('disabled', 'disabled'),
                                                    this._controls.layoutNavbarFixedW.classList.add('disabled')),
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        ...
                                        (t =
                                            '' !== r && -1 !== ['static', 'static-offcanvas', 'fixed', 'fixed-offcanvas'].indexOf(r) ?
                                            r :
                                            this.settings.defaultLayoutType),
                                        (this.settings.layoutType = t),
                                        (this.settings.rtl = '' !== e ? 'true' === e : this.settings.defaultTextDir),
                                        (this.settings.style = -1 !== this.settings.styles.indexOf(s) ? s : this.settings.defaultStyle), -1 === this.settings.styles.indexOf(this.settings.style) &&
                                            ...
                                            (this.settings.rtl = 'rtl' === document.documentElement.getAttribute('dir')),
                                            this._hasControls('style') || (this.settings.style = m.contains('dark-style') ? 'dark' : 'light'),
                                ...
                                },
                                {
                                    ...
                                    value: function() {
                                        ...
                                        this._cleanup(), (this.container = this._getElementFromString(l()));
                                        ...
                                        var r = this.container.querySelector('.template-customizer-misc');
                                        ...
                                        if (
                                            this._hasControls(
                                                'layoutType layoutNavbarFixed layoutFooterFixed layoutMenuFlipped showDropdownOnHover', !0
                                            )
                                        ) {
                                            ...
                                            if (
                                                ...
                                                (this._controls.showDropdownOnHover =
                                                    this._controls.showDropdownOnHover.querySelector('input')),
                                                this.settings.showDropdownOnHover &&
                                            ...
                                            this._insertStylesheet(
                                                ...
                                                this.pathResolver(
                                                    ...
                                                    this.settings.cssFilenamePattern.replace(
                                                        ...
                                                        ('light' !== this.settings.style ? '-'.concat(this.settings.style) : '')
                                                    )
                                                )
                                            );
                                        else {
                                ...
                                },
                                {
                                    ...
                                    value: function(t, e) {
                                        ...
                                        if ('number' == typeof document.documentMode && document.documentMode < 11) {
                                            ...
                                            document.write(
                                                '<link rel="stylesheet" type="text/css" href="'.concat(e, '" class="').concat(t, '">')
                                            );
                                        ...
                                        function a(t, e, s) {
                                            ...
                                            (o = setInterval(function() {
                                                try {
                                                    i[a] &&
                                                        i[a][n].length &&
                                                        (clearInterval(o), clearTimeout(l), e.parentNode.removeChild(e), s(!0));
                                                } catch (t) {}
                                            }, 10)),
                ...
                (S.THEMES = [
                    { name: 'theme-default', title: lang == 'en' ? "المفترض" : 'Default' },
                    { name: 'theme-semi-dark', title: lang == 'en' ? "شبه داكن" : 'Semi Dark' },
                    { name: 'theme-bordered', title: lang == 'en' ? " الحدود" : 'Borders' }
                ]),
                (S.LANGUAGES = {
                    en: {
                    ...
                    ar: {
                        panel_header: ' تعديل التصميم',
                        panel_sub_header: 'التخصيص والمعاينة في الوقت الحقيقي',
                        theming_header: 'السمات',
                        theme_header: 'سمة',
                        theme_label: 'السمات',
                        style_label: 'نمط (وضع)',
                        style_switch_light: 'ضوء',
                        style_switch_dark: 'مظلم',
                        layout_header: 'تصميم',
                        layout_label: 'تصميم (القائمة)',
                        layout_static: 'ثابتة',
                        layout_offcanvas: 'Offcanvas',
                        layout_fixed: 'مثبت',
                        layout_fixed_offcanvas: 'مثبت offcanvas',
                        layout_flipped_label: 'Menu flipped',
                        layout_dd_open_label: 'القائمة المنسدلة عند التمرير',
                        layout_navbar_label: 'مثبت navbar',
                        layout_footer_label: 'مثبت footer',
                        misc_header: 'MISC',
                        rtl_label: 'RTL direction'
                    },
                    de: {
