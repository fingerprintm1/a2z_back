		...
		<div class="col-12">
			...
			<div class="bs-stepper wizard-numbered mt-2">
				...
				<div class="bs-stepper-content">
					<form class="card-body" action="{{ route('question_save', [$course->id, $lecture->id]) }}" method="POST"
						...
						<div id="step_1" class="content">
										...
										<div class="col-md">
											<div class="form-check custom-option custom-option-basic">
												<label class="form-check-label custom-option-content "
													...
													<input name="related" @if(old('related')==="assignments" ) checked @endif
							...
							<div class="row mt-4" id="question_text">
								<div class="col-12">
									<div class="card">
