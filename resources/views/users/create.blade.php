...
@section('title', trans("global.create_new_user"))
...
@section('content')
	...
	@php
		$links = [
			...
			"end" => trans("global.create_user"),
	]
	@endphp
	@include("layouts.breadcrumbs")
	<!-- Multi Column with Form Separator -->
	<div class="card mb-4">
		<h5 class="card-header">@lang("global.create_new_user")</h5>
		<form class="card-body" action="{{route('user_save')}}" method="POST" enctype="multipart/form-data">
			@csrf
			<div class="row g-3">
				@if ($errors->any())
				...
				<div class="col-md-6">
					...
					<input value="{{ old('name_ar') }}" name="name_ar" type="text" id="name_ar" class="form-control @error('name_ar') is-invalid @enderror" placeholder="@lang("global.name_ar")" />
				</div>
				<div class="col-md-6">
					<label class="form-label " for="name_en">@lang("global.name_en")</label>
					<input value="{{ old('name_en') }}" name="name_en" type="text" id="name_en" class="form-control @error('name_en') is-invalid @enderror" placeholder="@lang("global.name_en")" />
				</div>
				...
				<div class="col-md-6">
					...
					{{--					<input value="{{ old('email') }}" readonly style="background: transparent;border: 0 !important;width: 86%;margin: 0 !important; text-align: end" type="text" name="email" id="email_value" class="focus-none  text-fp2 font-bold me-2 -mb-1" />--}}
				...
				<div class="mt-3 col-md-6 pe-2">
					...
					<input class="form-control  @error('phone') is-invalid @enderror" value="{{ old('phone') }}" name="phone" type="tel" placeholder="201090844348" id="html5-tel-input" />
				</div>
				<div class="mt-3 col-md-6 ">
					<label for="html5-tel-input" class="col-md-2 col-form-label">@lang("global.phone_parent")</label>
					<input class="form-control  @error('phone_parent') is-invalid @enderror" value="{{ old('phone_parent') }}" name="phone_parent" type="tel" placeholder="201090844348" id="html5-tel-input" />
				</div>
				<div class="col-6 mt-4">
					<label for="balance" class="form-label mb-2">@lang("global.balance")</label>
					<input type="text" value="{{ old("balance", 00.00) }}" class="form-control @error('balance') is-invalid @enderror" id="balance" name="balance" placeholder="999.00" aria-describedby="defaultFormControlHelp" />
				</div>
				<div class="col-6 mt-4">
