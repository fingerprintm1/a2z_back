...
@section('title', trans("global.payment_method"))
...
@section('page-script')
	<script src="{{asset('assets/js/payment_methods.js')}}"></script>
@endsection
			...
			<div class="d-flex align-items-center justify-content-between">
				...
				<div class="d-flex align-items-center">
					<div class="demo-inline-spacing  me-3">
						<div class="btn-group mt-0">
							...
							<ul class="dropdown-menu">
								<li>
									<form action="{{route('payment_method_delete_all')}}" method="POST" id="form-delete-all" class="position-relative dropdown-item cursor-pointer" tabindex="0" aria-controls="DataTables_Table_0">
					...
					@can("create_payment_methods")
						<a class="btn btn-secondary btn-primary position-relative" tabindex="0" aria-controls="DataTables_Table_0" href="{{route('payment_method_create')}}">
							<span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span class="d-none d-sm-inline-block">{{trans("global.create_payment_method")}}</span></span>
						</a>
					@endcan
				</div>
			</div>
