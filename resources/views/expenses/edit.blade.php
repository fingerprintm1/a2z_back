...
@section('title', trans('global.edit_expenses'))
...
@section('content')
	...
	@php
		$links = [
				...
				'end' => trans('global.edit_expenses'),
		];
	@endphp
	@include('layouts.breadcrumbs')
	<!-- Multi Column with Form Separator -->
	<div class="card mb-4">
		<h5 class="card-header">{{ trans('global.edit_expenses') }}</h5>
		<form class="card-body" action="{{ route('expenses_update', $expense->id) }}" method="POST"
			...
			<div class="row g-3">
				...
				<div class="col-md-6">
					...
					<input required value="{{ old('name_ar', $expense->name_ar) }}" name="name_ar" type="text"
				...
				<div class="col-md-6">
					...
					<input required value="{{ old('name_en', $expense->name_en) }}" name="name_en" type="text"
