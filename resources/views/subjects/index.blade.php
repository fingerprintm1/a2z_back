...
@section('title', trans('global.subject'))
			...
			<div class="d-flex align-items-center justify-content-between">
				...
				<div class="d-flex align-items-center">
					...
					<a class="btn btn-secondary btn-primary position-relative" tabindex="0"
					   aria-controls="DataTables_Table_0" href="{{ route('subject_create') }}">
                        <span><i class="ti ti-plus me-0 me-sm-1 ti-xs"></i><span
		                        class="d-none d-sm-inline-block">{{ trans('global.create_subject') }}</span></span>
					</a>
					{{--					@endcan--}}
